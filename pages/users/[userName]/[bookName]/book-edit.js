  ...
  return (
    <>
      ...
      <AppHead
        ...
        url={`${RSC.domain}/users/${userName}/${bookName}/book-edit`}
      />
      <AppLayout>
        <div
        ...
        >
            ...
            <GridContainer justify="center">
              <GridItem xs={12} sm={10} md={10}>
                ...
                <Card className={classes.cardSignup}>
                  <h2 className={classes.cardTitle}>手記編集</h2>
                  <GridContainer justify="center">
                  ...
                  <CardBody>
                    <GridContainer justify="center">
                      <GridItem xs={12} sm={10} md={10}>
                        <BookForm classes userData={userData} bookData={bookData} />
                      </GridItem>
                    </GridContainer>
                  </CardBody>
                </Card>
          ...
          {/* ログインしているが他人の手記を編集しようとしているとき */}
          {authUserData.uid !== userData.uid && (
            <SimpleModal
              modalTitle={`手記を編集できるのは自分のデータに対してのみです`}
              modalText="トップページへ移動します"
              closeBtnTxt=""
              yesBtnTxt="OK"
              noBtnTxt=""
